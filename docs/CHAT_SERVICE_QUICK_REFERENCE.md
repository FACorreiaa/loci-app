...
**Location:** `/app/pkg/domain/llmChat/chat_service.go` (Line 1902)
...
See: `/app/pkg/domain/llmChat/chat_service_test.go`
...
| Purpose | Path |
|---------|------|
| Full implementation | `/app/pkg/domain/llmChat/chat_service.go` |
