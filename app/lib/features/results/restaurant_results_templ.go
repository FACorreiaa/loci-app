...
func RestaurantResults(restaurants []RestaurantDetailedInfo, compact bool, showToggle bool, initialLimit int, favorites []string, isLoadingFavorites bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if showToggle && len(restaurants) > initialLimit {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 29, Col: 85}
			}
...
func RestaurantCard(restaurant RestaurantDetailedInfo, compact bool, isFavorite bool, isLoadingFavorites bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 84, Col: 80}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 94, Col: 24}
		}
		...
		if restaurant.CuisineType != nil && *restaurant.CuisineType != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 98, Col: 33}
			}
		...
		if restaurant.Address != nil && *restaurant.Address != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 104, Col: 29}
			}
		...
		if restaurant.PhoneNumber != nil && *restaurant.PhoneNumber != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 110, Col: 33}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 118, Col: 48}
		}
		...
		if !isLoadingFavorites {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 124, Col: 68}
			}
		...
		if !compact && restaurant.Description != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 153, Col: 30}
			}
		...
		for _, tag := range restaurant.Tags {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 159, Col: 12}
			}
		...
		if restaurant.PriceLevel != nil && *restaurant.PriceLevel != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 169, Col: 33}
			}
		...
		if restaurant.OpeningHours != nil && *restaurant.OpeningHours != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 177, Col: 35}
			}
