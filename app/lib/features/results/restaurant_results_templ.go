...
func RestaurantResults(restaurants []RestaurantDetailedInfo, compact bool, showToggle bool, initialLimit int, favorites []string, isLoadingFavorites bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if showToggle && len(restaurants) > initialLimit {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 30, Col: 85}
			}
...
func RestaurantCard(restaurant RestaurantDetailedInfo, compact bool, isFavorite bool, isLoadingFavorites bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 86, Col: 80}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 95, Col: 24}
		}
		...
		if restaurant.CuisineType != nil && *restaurant.CuisineType != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 100, Col: 33}
			}
		...
		if restaurant.Address != nil && *restaurant.Address != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 107, Col: 29}
			}
		...
		if restaurant.PhoneNumber != nil && *restaurant.PhoneNumber != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 114, Col: 33}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 1, Col: 0}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 123, Col: 48}
		}
		...
		if !isLoadingFavorites {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 130, Col: 68}
			}
		...
		if !compact && restaurant.Description != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 158, Col: 30}
			}
		...
		for _, tag := range restaurant.Tags {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 165, Col: 12}
			}
		...
		if restaurant.PriceLevel != nil && *restaurant.PriceLevel != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 176, Col: 33}
			}
		...
		if restaurant.OpeningHours != nil && *restaurant.OpeningHours != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/features/results/restaurant_results.templ`, Line: 185, Col: 35}
			}
