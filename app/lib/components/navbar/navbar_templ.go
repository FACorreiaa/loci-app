	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.User == nil {
			...
			if props.User.Name != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/components/navbar/navbar.templ`, Line: 262, Col: 37}
				}
			...
			if props.User.Name != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/components/navbar/navbar.templ`, Line: 269, Col: 26}
				}
		...
		if props.User == nil {
			...
			if props.User.Name != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/components/navbar/navbar.templ`, Line: 464, Col: 37}
				}
			...
			if props.User.Name != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/components/navbar/navbar.templ`, Line: 472, Col: 27}
				}
			...
			if props.User.Email != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/lib/components/navbar/navbar.templ`, Line: 479, Col: 28}
				}
