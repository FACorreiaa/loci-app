...
func (r *RepositoryImpl) updateAccommodationPreferencesInTx(ctx context.Context, tx pgx.Tx, profileID uuid.UUID, prefs *models.AccommodationPreferences) error {
...
func (r *RepositoryImpl) updateDiningPreferencesInTx(ctx context.Context, tx pgx.Tx, profileID uuid.UUID, prefs *models.DiningPreferences) error {
	// Convert preferences to JSONB
	filters := map[string]interface{}{
...
func (r *RepositoryImpl) updateActivityPreferencesInTx(ctx context.Context, tx pgx.Tx, profileID uuid.UUID, prefs *models.ActivityPreferences) error {
	// Convert preferences to JSONB
	filters := map[string]interface{}{
...
func (r *RepositoryImpl) updateItineraryPreferencesInTx(ctx context.Context, tx pgx.Tx, profileID uuid.UUID, prefs *models.ItineraryPreferences) error {
	// Convert preferences to JSONB
	filters := map[string]interface{}{
