...
func (m *MocktagsRepo) Update(ctx context.Context, userID uuid.UUID, tagID uuid.UUID, params models.UpdatePersonalTagParams) error {
...
func TestTagsServiceImpl_GetTag(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		expectedTag := &models.Tags{ID: tagID, Name: "Specific Tag", TagType: "preference"}
	...
	t.Run("repository error - not found", func(t *testing.T) {
		repoErr := errors.New("tag not found in repo") // Or models.ErrNotFound
...
func TestTagsServiceImpl_CreateTag(t *testing.T) {
	...
	params := models.CreatePersonalTagParams{
		Name:        "SpicyLover",
		Description: desc,
		TagType:     "preference",
	}
	expectedPersonalTag := &models.PersonalTag{
		ID:          uuid.New(),
		UserID:      userID,
		Name:        params.Name,
		Description: &desc,
...
func TestTagsServiceImpl_Update(t *testing.T) {
	...
	params := models.UpdatePersonalTagParams{
		Name:        newName,
		Description: newDesc,
		TagType:     "preference",
	}
	...
	t.Run("no fields to update (service passes to repo)", func(t *testing.T) {
		emptyParams := models.UpdatePersonalTagParams{}
