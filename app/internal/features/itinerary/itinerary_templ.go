...
func ItineraryWelcomeMessage() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "<div class=\"flex items-start space-x-3\"><div class=\"w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center flex-shrink-0\"><i class=\"fas fa-robot text-white text-sm\"></i></div><div class=\"bg-gray-100 rounded-lg p-4 max-w-md\"><p class=\"text-gray-800\">Hi! I'm your travel planning assistant. I can help you create amazing itineraries,  find the best places to visit, restaurants to try, and hotels to stay at.</p><p class=\"text-gray-800 mt-2\">To get started, tell me where you'd like to go and I'll create a personalized itinerary for you!</p></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func ItineraryChatMessage(message models.ChatMessage, isUser bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/internal/features/itinerary/itinerary.templ`, Line: 1, Col: 0}
		}
		...
		if isUser {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "<i class=\"fas fa-user text-white text-sm\"></i>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		} else {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, "<i class=\"fas fa-robot text-white text-sm\"></i>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/internal/features/itinerary/itinerary.templ`, Line: 460, Col: 21}
		}
		...
		if message.Timestamp != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/internal/features/itinerary/itinerary.templ`, Line: 467, Col: 24}
			}
...
func ItineraryPOICard(poi models.NearbyPOI) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if poi.ImageURL != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/internal/features/itinerary/itinerary.templ`, Line: 482, Col: 28}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/internal/features/itinerary/itinerary.templ`, Line: 482, Col: 45}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var18))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 26, "\" class=\"w-full h-full object-cover rounded-lg\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		} else {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 27, "<div class=\"w-full h-full bg-gradient-to-br from-blue-400 to-purple-500 rounded-lg flex items-center justify-center\"><i class=\"fas fa-map-marker-alt text-white text-sm\"></i></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 28, "</div><div class=\"flex-1 min-w-0\"><h4 class=\"font-medium text-gray-900 truncate\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/internal/features/itinerary/itinerary.templ`, Line: 490, Col: 61}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var19))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 29, "</h4><p class=\"text-sm text-gray-600\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/internal/features/itinerary/itinerary.templ`, Line: 491, Col: 51}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var20))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 30, "</p><div class=\"flex items-center mt-1\"><div class=\"flex items-center\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for i := 0; i < int(poi.Rating); i++ {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 31, "<i class=\"fas fa-star text-yellow-400 text-xs\"></i>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 32, "</div><span class=\"ml-1 text-xs text-gray-500\">(")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/internal/features/itinerary/itinerary.templ`, Line: 498, Col: 59}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var21))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 33, ")</span></div></div><button class=\"bg-blue-600 text-white px-3 py-1 rounded-md text-sm hover:bg-blue-700 transition-colors\"><i class=\"fas fa-plus mr-1\"></i> Add</button></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func ItineraryPageWithQuery(query string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 34, "<div class=\"h-full flex\" x-data=\"itineraryPageWithQuery()\"><!-- Left Panel - Chat/Text Content --><div class=\"w-1/2 flex flex-col bg-white\"><!-- Header --><div class=\"p-6 border-b border-gray-200 bg-gray-50\"><div class=\"flex items-center justify-between mb-4\"><h1 class=\"text-2xl font-bold text-gray-900\">Travel Planner</h1><div class=\"flex items-center space-x-2\"><button id=\"new-itinerary-btn\" class=\"bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm\"><i class=\"fas fa-plus mr-2\"></i> New Plan</button></div></div><!-- Location Input --><div class=\"relative mb-4\"><input type=\"text\" id=\"destination-input\" placeholder=\"Where do you want to go? (e.g., Paris, France)\" class=\"w-full px-4 py-3 pl-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent\" hx-post=\"/itinerary/destination\" hx-trigger=\"input changed delay:500ms, keyup[keyCode==13]\" hx-target=\"#destination-suggestions\" hx-include=\"this\"> <i class=\"fas fa-map-marker-alt absolute left-3 top-3.5 text-gray-400\"></i></div><!-- Destination Suggestions --><div id=\"destination-suggestions\" class=\"mb-4\"></div><!-- Travel Preferences --><div class=\"grid grid-cols-3 gap-4\"><div><label class=\"block text-sm font-medium text-gray-700 mb-1\">Duration</label> <select id=\"trip-duration\" name=\"duration\" class=\"w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500\"><option value=\"1\">1 Day</option> <option value=\"3\">3 Days</option> <option value=\"5\" selected>5 Days</option> <option value=\"7\">1 Week</option> <option value=\"14\">2 Weeks</option></select></div><div><label class=\"block text-sm font-medium text-gray-700 mb-1\">Budget</label> <select id=\"trip-budget\" name=\"budget\" class=\"w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500\"><option value=\"budget\">Budget</option> <option value=\"moderate\" selected>Moderate</option> <option value=\"luxury\">Luxury</option></select></div><div><label class=\"block text-sm font-medium text-gray-700 mb-1\">Style</label> <select id=\"trip-style\" name=\"style\" class=\"w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500\"><option value=\"cultural\">Cultural</option> <option value=\"adventure\">Adventure</option> <option value=\"relaxation\" selected>Relaxation</option> <option value=\"foodie\">Foodie</option> <option value=\"nightlife\">Nightlife</option></select></div></div></div><!-- Chat Interface --><div class=\"flex-1 flex flex-col\"><!-- Chat Messages --><div id=\"chat-messages\" class=\"flex-1 overflow-y-auto p-6 space-y-4\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 35, "</div><!-- Chat Input --><div class=\"border-t border-gray-200 p-4 bg-gray-50\"><form id=\"chat-form\" hx-post=\"/itinerary/chat\" hx-target=\"#chat-messages\" hx-swap=\"beforeend\" hx-include=\"#destination-input, #trip-duration, #trip-budget, #trip-style\"><div class=\"flex items-center space-x-3\"><div class=\"flex-1 relative\"><textarea name=\"message\" id=\"chat-input\" placeholder=\"Ask me anything about your trip... (e.g., 'Add a romantic restaurant for dinner')\" class=\"w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none\" rows=\"1\" style=\"min-height: 44px;\"></textarea> <button type=\"submit\" class=\"absolute right-2 top-1/2 transform -translate-y-1/2 bg-blue-600 text-white p-2 rounded-lg hover:bg-blue-700 transition-colors\"><i class=\"fas fa-paper-plane\"></i></button></div></div></form><!-- Quick Actions --><div class=\"flex flex-wrap gap-2 mt-3\"><button class=\"quick-action-btn\" data-message=\"Create a 3-day itinerary\"><i class=\"fas fa-route mr-1\"></i> 3-Day Plan</button> <button class=\"quick-action-btn\" data-message=\"Find the best restaurants\"><i class=\"fas fa-utensils mr-1\"></i> Restaurants</button> <button class=\"quick-action-btn\" data-message=\"Show me popular attractions\"><i class=\"fas fa-camera mr-1\"></i> Attractions</button> <button class=\"quick-action-btn\" data-message=\"Recommend hotels\"><i class=\"fas fa-bed mr-1\"></i> Hotels</button></div></div></div></div><!-- Right Panel - Map --><div class=\"w-1/2 bg-gray-100\"><div class=\"h-full flex flex-col\"><!-- Map Header --><div class=\"p-4 bg-white border-b border-gray-200\"><div class=\"flex items-center justify-between\"><h2 class=\"font-semibold text-gray-900\">Map View</h2><div class=\"flex items-center space-x-2\"><button id=\"map-layer-toggle\" class=\"bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-sm hover:bg-gray-200 transition-colors\"><i class=\"fas fa-layer-group mr-1\"></i> Layers</button> <button id=\"map-center-btn\" class=\"bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-sm hover:bg-gray-200 transition-colors\"><i class=\"fas fa-crosshairs mr-1\"></i> Center</button></div></div></div><!-- Map Container --><div class=\"flex-1 relative\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = mapcomponents.MapboxContainer("itinerary-map", "100%").Render(ctx, templ_7745c5c3_Buffer)
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 36, "<!-- Map Controls --><div class=\"absolute top-4 right-4 bg-white rounded-lg shadow-lg p-2 space-y-2\"><button class=\"map-control-btn active\" data-layer=\"attractions\" title=\"Show Attractions\"><i class=\"fas fa-camera\"></i></button> <button class=\"map-control-btn\" data-layer=\"restaurants\" title=\"Show Restaurants\"><i class=\"fas fa-utensils\"></i></button> <button class=\"map-control-btn\" data-layer=\"hotels\" title=\"Show Hotels\"><i class=\"fas fa-bed\"></i></button> <button class=\"map-control-btn\" data-layer=\"transport\" title=\"Show Transport\"><i class=\"fas fa-subway\"></i></button></div></div><!-- Current Itinerary Summary --><div class=\"bg-white border-t border-gray-200 p-4\"><h3 class=\"font-semibold text-gray-900 mb-3\">Current Itinerary</h3><div id=\"itinerary-summary\" class=\"space-y-2\"><div id=\"streaming-content\" class=\"text-center py-6 text-gray-500\"><div class=\"spinner-border animate-spin inline-block w-4 h-4 border-2 rounded-full border-blue-600 border-t-transparent\" role=\"status\"><span class=\"sr-only\">Loading...</span></div><p class=\"text-sm mt-2\">Planning your itinerary...</p></div></div></div></div></div><script>\n\t\t\tfunction itineraryPageWithQuery() {\n\t\t\t\treturn {\n\t\t\t\t\tshowChat: false,\n\t\t\t\t};\n\t\t\t}\n\t\t</script><!-- Chat Panel for continuing conversation -->")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = chat.ChatPanel(chat.ChatPanelProps{
...
func ItineraryInitialMessage(query string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 38, "<div class=\"flex items-start space-x-3\"><div class=\"w-8 h-8 bg-gray-600 rounded-full flex items-center justify-center flex-shrink-0\"><i class=\"fas fa-user text-white text-sm\"></i></div><div class=\"bg-blue-600 text-white rounded-lg p-4 max-w-md\"><p>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/internal/features/itinerary/itinerary.templ`, Line: 980, Col: 13}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var24))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 39, "</p></div></div><div class=\"flex items-start space-x-3\"><div class=\"w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center flex-shrink-0\"><i class=\"fas fa-robot text-white text-sm\"></i></div><div class=\"bg-gray-100 rounded-lg p-4 max-w-md\"><div class=\"spinner-border animate-spin inline-block w-4 h-4 border-2 rounded-full border-blue-600 border-t-transparent mr-2\" role=\"status\"><span class=\"sr-only\">Loading...</span></div><span class=\"text-gray-800\">Let me create an amazing itinerary for you...</span></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func ItineraryEmptyState() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 40, "<div class=\"text-center py-6 text-gray-500\"><i class=\"fas fa-map-marked-alt text-2xl mb-2\"></i><p class=\"text-sm\">Your itinerary will appear here</p><p class=\"text-xs\">Start chatting to build your trip!</p></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func ItinerarySummaryItem(day int, items []models.NearbyPOI) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 41, "<div class=\"mb-3\"><h4 class=\"font-medium text-gray-900 mb-2\">Day ")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/internal/features/itinerary/itinerary.templ`, Line: 1006, Col: 73}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var27))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 42, "</h4><div class=\"space-y-2\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for _, item := range items {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 43, "<div class=\"flex items-center justify-between text-sm\"><div class=\"flex items-center space-x-2\"><div class=\"w-2 h-2 bg-blue-600 rounded-full\"></div><span class=\"text-gray-700\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/internal/features/itinerary/itinerary.templ`, Line: 1012, Col: 45}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var28))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 44, "</span></div><button class=\"text-red-500 hover:text-red-700\" onclick=\"removeFromItinerary('{item.ID}')\"><i class=\"fas fa-times text-xs\"></i></button></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
...
func ItineraryDestinationSuggestions(suggestions []string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(suggestions) > 0 {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 46, "<div class=\"bg-white border border-gray-200 rounded-lg shadow-sm\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			for _, suggestion := range suggestions {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 47, "<div class=\"p-3 hover:bg-gray-50 cursor-pointer border-b border-gray-100 last:border-b-0\" onclick=\"selectDestination('{suggestion}')\"><div class=\"flex items-center space-x-2\"><i class=\"fas fa-map-marker-alt text-gray-400\"></i> <span class=\"text-gray-700\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/internal/features/itinerary/itinerary.templ`, Line: 1033, Col: 46}
				}
