	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.User == nil {
			...
			if props.User.Name != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/internal/components/navbar/navbar.templ`, Line: 266, Col: 37}
				}
			...
			if props.User.Name != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/internal/components/navbar/navbar.templ`, Line: 273, Col: 26}
				}
		...
		if props.User == nil {
			...
			if props.User.Name != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/internal/components/navbar/navbar.templ`, Line: 469, Col: 37}
				}
			...
			if props.User.Name != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/internal/components/navbar/navbar.templ`, Line: 477, Col: 27}
				}
			...
			if props.User.Email != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/internal/components/navbar/navbar.templ`, Line: 484, Col: 28}
				}
