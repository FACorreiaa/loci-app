...
func (m *MockUserRepo) GetUserByID(ctx context.Context, userID uuid.UUID) (*models.UserProfile, error) {
...
func (m *MockUserRepo) UpdateProfile(ctx context.Context, userID uuid.UUID, params models.UpdateProfileParams) error {
...
func TestServiceUserImpl_GetUserProfile(t *testing.T) {
	...
	t.Run("repository error - not found", func(t *testing.T) {
		...
		repoErr := errors.New("user not found in repo") // Or a specific models.ErrNotFound
