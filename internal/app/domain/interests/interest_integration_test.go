...
func createTestInterestDirectly(t *testing.T, name string, description *string, isActive bool, createdByUserID string) *models.Interest {
	t.Helper()
...
func TestinterestsServiceImpl_CreateInterest_Integration(t *testing.T) {
	...
	t.Run("Attempt to create duplicate interest name (if repo handles it)", func(t *testing.T) {
		...
		// If it returns a specific error (e.g., models.ErrConflict), test for that.
		...
		// Example: assert.True(t, errors.Is(err, models.ErrConflict)) or check for specific DB error code
...
func TestinterestsServiceImpl_UserFavouriteInterests_Integration(t *testing.T) {
	...
	t.Run("Get favourite interests for user1", func(t *testing.T) {
		...
		// Let's assume GetFavouritePOIsByUserID actually returns models.Interest linked to the user
...
func TestinterestsServiceImpl_Updateinterests_Integration(t *testing.T) {
	...
	// Your current Updateinterests params models.UpdateinterestsParams is empty.
	...
	t.Run("Update non-existent interest", func(t *testing.T) {
		...
		updateParams := models.UpdateinterestsParams{Name: &newName}
