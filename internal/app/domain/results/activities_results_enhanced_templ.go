...
func ActivitiesResults(cityData models.GeneralCityData, activities []models.POIDetailedInfo, compact bool, showToggle bool, initialLimit int, favorites []string, sessionID string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"min-h-screen bg-gray-50 dark:bg-gray-900 activities-results\" id=\"activities-container\" x-data=\"activitiesPage()\"><!-- Mobile-First Enhanced Header -->/lo<div class=\"bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-30\"><div class=\"px-4 py-3 sm:px-6\"><!-- Main Header Content --><div class=\"flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between\"><div class=\"flex-1 min-w-0\"><div class=\"flex items-center gap-3\"><div class=\"w-10 h-10 bg-gradient-to-br from-purple-500 to-blue-600 rounded-lg flex items-center justify-center text-white text-xl flex-shrink-0\">🎯</div><div class=\"flex-1 min-w-0\"><h1 class=\"text-lg font-bold text-gray-900 dark:text-white sm:text-xl truncate\">")
		if templ_7745c5c3_Err != nil {
		...
		if cityData.City != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 25, Col: 39}
			}
		...
		if cityData.City != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 37, Col: 51}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 37, Col: 103}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 37, Col: 125}
			}
			...
			if cityData.Population != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 40, Col: 38}
				}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 50, Col: 52}
		}
		...
		if len(favorites) > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 57, Col: 52}
			}
		...
		if cityData.City != "" && cityData.Description != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 174, Col: 95}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 175, Col: 96}
			}
			...
			if cityData.Area != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 182, Col: 80}
				}
			...
			if cityData.Timezone != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 190, Col: 78}
				}
			...
			if cityData.Language != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 198, Col: 88}
				}
			...
			if cityData.Population != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 206, Col: 92}
				}
...
func ActivityListCard(activity models.POIDetailedInfo, index int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 417, Col: 29}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 423, Col: 21}
		}
		...
		if activity.Category != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 426, Col: 67}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 427, Col: 44}
			}
		...
		if activity.Category != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 433, Col: 25}
			}
		...
		if activity.Rating > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 1, Col: 0}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 444, Col: 46}
			}
		...
		if activity.PriceLevel != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 450, Col: 27}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 455, Col: 94}
		}
		...
		if activity.Distance > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 463, Col: 63}
			}
		...
		if activity.TimeToSpend != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 471, Col: 33}
			}
		...
		if len(activity.OpeningHours) > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 479, Col: 71}
			}
		...
		if activity.Address != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 483, Col: 45}
			}
		...
		if len(activity.Tags) > 0 {
			...
			for i, tag := range activity.Tags {
				if i < 4 {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 492, Col: 12}
					}
			...
			if len(activity.Tags) > 4 {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 498, Col: 48}
				}
		...
		if activity.Website != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 508, Col: 40}
			}
		...
		if activity.PhoneNumber != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 521, Col: 53}
			}
...
func ActivityGridCard(activity models.POIDetailedInfo, index int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 548, Col: 29}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 552, Col: 88}
		}
		...
		if activity.Rating > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 558, Col: 112}
			}
		...
		if activity.Category != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 564, Col: 24}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 567, Col: 95}
		}
		...
		if activity.PriceLevel != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/app/domain/results/activities_results_enhanced.templ`, Line: 570, Col: 85}
			}
