...
func createTestInterestForProfileTests(t *testing.T, name string, userID uuid.UUID) *models.Interest {
	t.Helper()
...
func createTestTagForProfileTests(t *testing.T, name string, userID uuid.UUID) *models.Tags {
	t.Helper()
...
func TestprofilessServiceImpl_Integration(t *testing.T) {
	...
	t.Run("CreateSearchProfile", func(t *testing.T) {
		params1 := models.CreateUserPreferenceProfileParams{
		...
		params2 := models.CreateUserPreferenceProfileParams{
	...
	t.Run("UpdateSearchProfile", func(t *testing.T) {
		...
		newRadius := 15.5
		updateParams := models.UpdateSearchProfileParams{
			ProfileName:    &newName,
...
// To run:
// TEST_DATABASE_URL="postgres://user:pass@host:port/dbname_test?sslmode=disable" go test -v ./app/profiles -tags=integration -count=1
