...
import (
	...
	"github.com/FACorreiaa/go-templui/internal/app/features/recents"
...
type RecentsHandlers struct {
	recentsService Service
	logger         *zap.Logger
}

func NewRecentsHandlers(recentsService Service, logger *zap.Logger) *RecentsHandlers {
