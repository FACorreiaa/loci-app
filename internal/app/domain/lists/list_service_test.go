...
func TestServiceImpl_CreateTopLevelList(t *testing.T) {
	...
	t.Run("repository error", func(t *testing.T) {
		...
		require.Error(t, err)
		assert.Contains(t, err.Error(), "failed to create lists")
		mockRepo.AssertExpectations(t)
	})
}
...
func TestServiceImpl_CreateItineraryForList(t *testing.T) {
	...
	t.Run("parent lists not found", func(t *testing.T) {
		service, mockRepo := setupListServiceTest()

		repoErr := errors.New("lists not found")
		...
		require.Error(t, err)
		assert.Contains(t, err.Error(), "parent lists not found")
		mockRepo.AssertExpectations(t)
	})

	t.Run("user does not own parent lists", func(t *testing.T) {
		service, mockRepo := setupListServiceTest()
		...
		require.Error(t, err)
		assert.Contains(t, err.Error(), "user does not own parent lists")
		mockRepo.AssertExpectations(t)
	})
}
...
func TestServiceImpl_GetListDetails(t *testing.T) {
	...
	t.Run("success - public lists access", func(t *testing.T) {
		service, mockRepo := setupListServiceTest()
	...
	t.Run("access denied - private lists", func(t *testing.T) {
		service, mockRepo := setupListServiceTest()
		...
		require.Error(t, err)
		assert.Contains(t, err.Error(), "access denied to lists")
		mockRepo.AssertExpectations(t)
	})

	t.Run("lists not found", func(t *testing.T) {
		service, mockRepo := setupListServiceTest()
		...
		require.Error(t, err)
		assert.Contains(t, err.Error(), "lists not found")
		mockRepo.AssertExpectations(t)
	})
}
...
func TestServiceImpl_UpdateListDetails(t *testing.T) {
	...
	t.Run("user does not own lists", func(t *testing.T) {
		service, mockRepo := setupListServiceTest()
		...
		require.Error(t, err)
		assert.Contains(t, err.Error(), "user does not own lists")
		mockRepo.AssertExpectations(t)
	})
}
...
func TestServiceImpl_AddPOIListItem(t *testing.T) {
	...
	t.Run("lists is not an itinerary", func(t *testing.T) {
		service, mockRepo := setupListServiceTest()
		...
		require.Error(t, err)
		assert.Contains(t, err.Error(), "lists is not an itinerary")
		mockRepo.AssertExpectations(t)
	})
}
